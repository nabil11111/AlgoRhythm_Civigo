  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3" aria-busy={pending}>
      <div>
        ...
        <Input id="first_name" value={first} onChange={(e) => setFirst(e.target.value)} disabled={pending} />
      </div>
      <div>
        <Label htmlFor="last_name">Last name</Label>
        <Input id="last_name" value={last} onChange={(e) => setLast(e.target.value)} disabled={pending} />
      </div>
