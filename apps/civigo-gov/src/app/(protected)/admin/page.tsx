  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link href="/\(protected\)/admin/departments" className="border rounded p-4 hover:bg-gray-50">
          <div className="font-medium">Departments</div>
          <div className="text-sm text-gray-600">Manage departments</div>
        </Link>
        <Link href="/\(protected\)/admin/officers" className="border rounded p-4 hover:bg-gray-50">
